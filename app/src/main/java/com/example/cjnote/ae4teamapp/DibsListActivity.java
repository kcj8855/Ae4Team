...
public class DibsListActivity extends AppCompatActivity {
    ...
    public void setImageView() {
        firestore.collection("dib")
                .whereEqualTo("dibUserId", userId)
                .orderBy("dibTimestamp", Query.Direction.DESCENDING)
                .get()
                .addOnCompleteListener(new OnCompleteListener<QuerySnapshot>() {
                    ...
                    public void onComplete(@NonNull Task<QuerySnapshot> task) {
                        if (task.isSuccessful()) {
                            ...
                            if (taskSize == 0) {
                                TextView tempTV = new TextView(DibsListActivity.this);
                                tempTV.setText("찜목록이 없습니다.");
                            ...
                            for (DocumentSnapshot document : task.getResult()) {
                                ...
                                textView = new TextView(DibsListActivity.this);
                                Date date = new Date((long) document.getData().get("dibTimestamp"));
                                ...
                                postImageView.put(tempId, new ImageView(DibsListActivity.this));
                                ...
                                postView = new LinearLayout(DibsListActivity.this);
